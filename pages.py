  ...
  <div class="g2">
    <div class="srv-panel">
      ...
      <div class="srv-tiles">
        ...
        <div class="srv-tile" style="grid-column:1/-1"><div class="srv-tile-icon"><i class="ti ti-device-floppy"></i></div><div class="srv-tile-text"><div class="srv-tile-label">ذخیره‌سازی</div><div class="srv-tile-val">Redis</div></div></div>
      </div>
    </div>
    <div class="pw-panel">
      <div class="pw-hero">
